...
> = {
  ...
  pl: {
    ...
    markPaid: "Oznacz jako oplacone",
    markReviewed: "Oznacz jako zweryfikowane",
    approve: "Zatwierdz",
    requestInfo: "Popros o informacje",
    reject: "Odrzuc",
    issuePassport: "Wydaj paszport",
    delete: "Usun",
    deleting: "Usuwanie...",
    confirmDelete: "Czy na pewno chcesz usunac te rejestracje?",
    deleteError: "Nie udalo sie usunac rejestracji.",
  },
  sv: {
    open: "Oppna",
    ...
    approve: "Godkann",
    requestInfo: "Begar info",
    reject: "Avvisa",
    issuePassport: "Utfarda pass",
    delete: "Radera",
    deleting: "Raderar...",
    confirmDelete: "Ar du saker pa att du vill radera den har registreringen?",
    deleteError: "Det gick inte att radera registreringen.",
  },
  da: {
    open: "Aabn",
    processing: "Behandler...",
    markPaid: "Marker betalt",
    markReviewed: "Marker gennemgaet",
    approve: "Godkend",
    requestInfo: "Anmod om info",
    reject: "Afvis",
    issuePassport: "Udsted pas",
    delete: "Slet",
    deleting: "Sletter...",
    confirmDelete: "Er du sikker pa, at du vil slette denne registrering?",
    deleteError: "Kunne ikke slette registreringen.",
  },
  no: {
    open: "Apne",
    processing: "Behandler...",
    markPaid: "Marker betalt",
    markReviewed: "Marker gjennomgatt",
    approve: "Godkjenn",
    requestInfo: "Be om info",
    reject: "Avvis",
    issuePassport: "Utsted pass",
    delete: "Slett",
    deleting: "Sletter...",
    confirmDelete: "Er du sikker pa at du vil slette denne registreringen?",
    deleteError: "Kunne ikke slette registreringen.",
  },};
