...
const TEXT: Record<Lang, CustomerDashboardText> = {
  ...
  pl: {
    dashboardTitle: "Panel",
    dashboardSubtitle:
      "Zarzadzaj rejestracjami, paszportami i danymi konta w jednym miejscu.",
    dashboardLink: "Panel",
    profileLink: "Moje dane",
    passportsLink: "Moje paszporty",
    newRegistration: "Nowa rejestracja",
    backToDashboard: "Wroc do panelu",
    profileTitle: "Moje dane",
    profileSubtitle: "Sprawdz dane konta powiazane z Twoim profilem EquipRegistry.",
    passportsTitle: "Moje paszporty",
    passportsSubtitle: "Wydane paszporty EquipRegistry powiazane z Twoim kontem.",
    noPassportsTitle: "Brak dostepnych paszportow",
    noPassportsText:
      "Wydane paszporty pojawia sie tutaj, gdy rejestracja uzyska status paszportu.",
    viewPassport: "Zobacz paszport",
    openRequest: "Otworz zgloszenie",
    profileLabels: {
      name: "Imie i nazwisko",
      email: "E-mail",
      company: "Firma",
      vat: "Numer VAT",
      verification: "Weryfikacja e-mail",
      status: "Status",
    },
    verified: "Zweryfikowano",
    unverified: "Oczekuje na weryfikacje",
    notProvided: "Nie podano",
  },
  sv: {
    dashboardTitle: "Instrumentpanel",
    dashboardSubtitle:
      "Hantera dina registreringar, pass och kontouppgifter fran ett och samma stalle.",
    dashboardLink: "Instrumentpanel",
    profileLink: "Mina uppgifter",
    passportsLink: "Mina pass",
    newRegistration: "Ny registrering",
    backToDashboard: "Tillbaka till instrumentpanelen",
    profileTitle: "Mina uppgifter",
    profileSubtitle: "Granska kontouppgifterna som ar kopplade till din EquipRegistry-profil.",
    passportsTitle: "Mina pass",
    passportsSubtitle: "Utfardade EquipRegistry-pass kopplade till ditt konto.",
    noPassportsTitle: "Inga pass tillgangliga an",
    noPassportsText:
      "Utfardade pass visas har sa snart en registrering far passstatus.",
    viewPassport: "Visa pass",
    openRequest: "Oppna arende",
    profileLabels: {
      name: "Namn",
      email: "E-post",
      company: "Foretag",
      vat: "Momsnummer",
      verification: "E-postverifiering",
      status: "Status",
    },
    verified: "Verifierad",
    unverified: "Verifiering vantar",
    notProvided: "Ej angivet",
  },
  da: {
    dashboardTitle: "Kontrolpanel",
    dashboardSubtitle:
      "Administrer dine registreringer, pas og kontooplysninger fra et sted.",
    dashboardLink: "Kontrolpanel",
    profileLink: "Mine oplysninger",
    passportsLink: "Mine pas",
    newRegistration: "Ny registrering",
    backToDashboard: "Tilbage til kontrolpanelet",
    profileTitle: "Mine oplysninger",
    profileSubtitle: "Gennemga kontooplysningerne, der er knyttet til din EquipRegistry-profil.",
    passportsTitle: "Mine pas",
    passportsSubtitle: "Udstedte EquipRegistry-pas knyttet til din konto.",
    noPassportsTitle: "Ingen pas tilgaengelige endnu",
    noPassportsText:
      "Udstedte pas vises her, sa snart en registrering far passtatus.",
    viewPassport: "Vis pas",
    openRequest: "Aben anmodning",
    profileLabels: {
      name: "Navn",
      email: "E-mail",
      company: "Virksomhed",
      vat: "Momsnummer",
      verification: "E-mailverificering",
      status: "Status",
    },
    verified: "Verificeret",
    unverified: "Afventer verificering",
    notProvided: "Ikke angivet",
  },
  no: {
    dashboardTitle: "Dashbord",
    dashboardSubtitle:
      "Administrer registreringer, pass og kontodetaljer fra ett sted.",
    dashboardLink: "Dashbord",
    profileLink: "Mine opplysninger",
    passportsLink: "Mine pass",
    newRegistration: "Ny registrering",
    backToDashboard: "Tilbake til dashbordet",
    profileTitle: "Mine opplysninger",
    profileSubtitle: "Se gjennom kontodetaljene som er knyttet til EquipRegistry-profilen din.",
    passportsTitle: "Mine pass",
    passportsSubtitle: "Utstedte EquipRegistry-pass knyttet til kontoen din.",
    noPassportsTitle: "Ingen pass tilgjengelige enn",
    noPassportsText:
      "Utstedte pass vises her sa snart en registrering far passstatus.",
    viewPassport: "Vis pass",
    openRequest: "Apne foresporsel",
    profileLabels: {
      name: "Navn",
      email: "E-post",
      company: "Firma",
      vat: "MVA-nummer",
      verification: "E-postverifisering",
      status: "Status",
    },
    verified: "Verifisert",
    unverified: "Venter pa verifisering",
