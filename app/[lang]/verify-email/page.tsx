...
const TEXT: Record<Lang, VerifyText> = {
  ...
  pl: {
    ...
    subtitle: "Potwierdz swoj adres e-mail, aby aktywowac konto i kontynuowac w istniejacym przeplywie panelu.",
    sentTitle: "Wyslano e-mail weryfikacyjny",
    sentText: "Sprawdz skrzynke odbiorcza i otworz link weryfikacyjny. Po potwierdzeniu przejdziesz bezposrednio do panelu.",
    invalidTitle: "Link weryfikacyjny niedostepny",
    invalidText: "Ten link weryfikacyjny jest nieprawidlowy lub zostal juz uzyty. Popros o nowy e-mail weryfikacyjny, jesli nadal potrzebujesz dostepu.",
    expiredTitle: "Link weryfikacyjny wygasl",
    expiredText: "Ten link weryfikacyjny wygasl. Rozpocznij ponownie etap weryfikacji, aby otrzymac nowy e-mail.",
    home: "Powrot na strone glowna",
    login: "Przejdz do logowania",
  },
  sv: {
    title: "Verifiera e-post",
    subtitle: "Bekrafta din e-postadress for att aktivera ditt konto och fortsatta i det befintliga dashboard-flodet.",
    sentTitle: "Verifieringsmail skickat",
    sentText: "Kontrollera inkorgen och oppna verifieringslanken. Efter bekraftelsen fortsatter du direkt till dashboarden.",
    invalidTitle: "Verifieringslanken ar inte tillganglig",
    invalidText: "Den har verifieringslanken ar ogiltig eller har redan anvants. Begar ett nytt verifieringsmail om du fortfarande behover atkomst.",
    expiredTitle: "Verifieringslanken har gatt ut",
    expiredText: "Den har verifieringslanken har gatt ut. Starta verifieringssteget igen for att fa ett nytt mail.",
    home: "Tillbaka till startsidan",
    login: "Ga till inloggning",
  },
  da: {
    title: "Bekraeft e-mail",
    subtitle: "Bekraeft din e-mailadresse for at aktivere din konto og fortsaette i det eksisterende dashboard-flow.",
    sentTitle: "Bekraeftelsesmail sendt",
    sentText: "Tjek din indbakke og aabn bekraeftelseslinket. Efter bekraeftelsen fortsaetter du direkte til dit dashboard.",
    invalidTitle: "Bekraeftelseslink utilgaengeligt",
    invalidText: "Dette bekraeftelseslink er ugyldigt eller er allerede blevet brugt. Anmod om en ny bekraeftelsesmail, hvis du stadig har brug for adgang.",
    expiredTitle: "Bekraeftelseslink udlobet",
    expiredText: "Dette bekraeftelseslink er udlobet. Start bekraeftelsestrinnet igen for at modtage en ny e-mail.",
    home: "Tilbage til forsiden",
    login: "Ga til login",
  },
  no: {
    title: "Verifiser e-post",
    subtitle: "Bekreft e-postadressen din for a aktivere kontoen din og fortsette i den eksisterende dashboard-flyten.",
    sentTitle: "Verifiseringsmail sendt",
    sentText: "Sjekk innboksen din og apne verifiseringslenken. Etter bekreftelsen fortsetter du direkte til dashboardet.",
    invalidTitle: "Verifiseringslenken er ikke tilgjengelig",
    invalidText: "Denne verifiseringslenken er ugyldig eller har allerede blitt brukt. Be om en ny verifiseringsmail hvis du fortsatt trenger tilgang.",
    expiredTitle: "Verifiseringslenken er utlopet",
    expiredText: "Denne verifiseringslenken er utlopet. Start verifiseringstrinnet pa nytt for a motta en ny e-post.",
    home: "Tilbake til startsiden",
    login: "Ga til innlogging",
  },
};
