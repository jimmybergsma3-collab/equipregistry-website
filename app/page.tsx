...
function getStatus(serial: string): Status {
  ...
  if (s === "ER-REG-001") {
    return {
      ...
      actions: [
        { label: "View passport", href: `/passport/${encodeURIComponent(s)}`, style: "primary" },
      ],
    };
  }
        ...
        <section className="py-20">
          <div className="max-w-3xl mx-auto text-center px-6">
            ...
            {status && (
              <div
                id="search-result"
                className={`mt-12 text-left rounded-xl p-6 border-2 ${status.color === "green"
                ...
                <div className="flex gap-3 flex-wrap">
                  {status.actions?.map((a, i) => (
                    <a
                      ...
                      className={`px-4 py-2 rounded-lg text-sm font-medium ${a.style === "primary"
